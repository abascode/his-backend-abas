...
class CalculationRepository(ICalculationRepository):
    ...
    def find_calculation(
        ...
        query = self.get_va_db(request).query(SlotCalculation).filter(SlotCalculation.deletable == 0)
    ...
    def create_calculation_detail(self, request: Request, calculation_detail: SlotCalculationDetail) -> None:
